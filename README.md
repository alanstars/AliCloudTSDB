...
## 安装方法
```
composer require coolelephant/aliyuntsdbapi
```
## 使用方法
本方法支持命名空间，如您的项目支持自动加载，直接实例化即可
```
$huaweiCloud = new \CoolElephant\AliCloudTSDB\AliCloudTSDB('a1d1f50cad21415fbdd13d8f53d36d60','cfc881cc704c4fba8d8fef5788e03e6b');
